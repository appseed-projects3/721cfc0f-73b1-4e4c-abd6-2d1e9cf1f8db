...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-03 20:38`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/721cfc0f-73b1-4e4c-abd6-2d1e9cf1f8db.git
$ cd 721cfc0f-73b1-4e4c-abd6-2d1e9cf1f8db
```
